...
import { ArrowRight, Loader2, Download, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="space-y-6">
        {/* URL Input Form */}
        <div>
          <h3 className={cn(patterns.heading.h3, "mb-2")}>Enter Website URL</h3>
          <p className={cn(patterns.text.muted, "mb-3")}>Get instant feedback on your website's design</p>
        ...
        <div className="relative py-2">
          ...
          <div className="relative flex justify-center">
            <span className={cn(patterns.text.muted, "px-4 bg-white")}>or</span>
          </div>
        </div>

        {/* Image Upload Area */}
        <div>
          <h3 className={cn(patterns.heading.h3, "mb-2")}>Upload or Paste Image</h3>
          <p className={cn(patterns.text.muted, "mb-3")}>Get feedback on your design mockups or screenshots</p>
          <div
            ...
            onDrop={handleDrop}
            className={cn(
              patterns.dropzone.base,
              dragActive ? patterns.dropzone.active : patterns.dropzone.inactive
            )}
          >
            <input
              type="file"
            ...
            <div className="space-y-3">
              <ImageIcon className="mx-auto w-14 h-14 text-gray-400" />
              <div>
                <p className={patterns.text.base}>
                  Drag and drop your image here, click to select, or paste (⌘V)
                </p>
                <p className={patterns.text.muted}>Supports PNG, JPG up to 5MB</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {result.screenshot && (
            <div className="relative max-h-[600px] overflow-hidden">
              ...
              <button
                ...
                className={cn(patterns.button.icon, "absolute top-4 right-4")}
